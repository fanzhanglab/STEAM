...
#' STEAM Visualization Functions
#' 
#' This file contains visualization functions for STEAM analysis results.
#' Core correction logic is handled in STEAMCorrection.R
#' Helper functions are in visualization_helpers.R
...
#' Create Iterative Plot for Specific Fold
#'
#' Shows before/after comparison for each iteration within a specific fold
#'
#' @param STEAM.obj STEAM object with correction results
#' @param fold Specific fold number to visualize (required)
#' @param iterations Specific iterations to show (optional). If NULL, shows all iterations.
#'Can be a single number or vector of numbers (e.g., c(0, 5, 10) for iterations 0, 5, and 10)
#' @return Combined ggplot showing iterations side by side
...
#' Accuracy Paired Bar Chart 
#'
#' Shows accuracy before and after corrections for each fold
#'
#' @param STEAM.obj STEAM object with correction results
#' @param show_improvements Whether to show improvement annotations (default: TRUE)
#' @param show_corrections Whether to show correction counts (default: TRUE)
...
#'
#' Shows relationship between local tissue homogeneity and correction success
#' Helps understand when spatial correction works best
#'
#' @param STEAM.obj STEAM object with correction results
#' @param k Number of neighbors to consider for homogeneity calculation (default: auto-detect)
#' @return ggplot object showing homogeneity vs success relationship
...
#' Error Analysis Plot
#'
#' Shows which tissue types are most/least likely to be corrected successfully
#' Confusion matrix style visualization for correction outcomes
#'
#' @param STEAM.obj STEAM object with correction results
#' @return ggplot object showing error analysis heatmap
