#' STEAM Correction for Misclassified Cells (Multi-fold) with Hierarchical Voting
#'
#' This implements automatic processing of all available folds with hierarchical voting system.
#' Uses multiple voting levels: 1st choice (most common neighbor), 2nd choice, etc.
#'
...
#' @param min_consensus Minimum proportion of neighbors that must agree for 1st choice corrections (default: 0.6)
...
#' @param min_secondary_consensus Minimum consensus for 2nd/3rd choice corrections (default: 0.3)
#' @param verbose Whether to print progress (default: TRUE)
#' @return Updated STEAM object with hierarchical corrections applied
